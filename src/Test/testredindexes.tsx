...
//import TestRedIndexesApp from './TestRedIndexesApp';
let TestRedIndexesApp = null;
if (typeof window?.fetch != 'undefined' && window?.fetch != null) {
    // Check whether ES6 is supported in Modern Browsers
    const module = await import("./TestRedIndexesApp");
    TestRedIndexesApp = module.default;
} else {
