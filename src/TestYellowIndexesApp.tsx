...
import SpeciesNameLookup from './Model/Yellow/SpeciesNameLookup';
...
import PokemonMovesLookup from './Model/Yellow/PokemonMovesLookup';
import TmsLookup from './Model/Yellow/TmsLookup';
import HmsLookup from './Model/Yellow/HmsLookup';
import MtsLookup from './Model/Yellow/MtsLookup';
import MoveLookup from './Model/Yellow/MoveLookup';
...
const TestYellowIndexesApp: FunctionComponent = () => {
...
export default TestYellowIndexesApp;
