export class PokemonStatsLookup {
	private static statsLookupKV = {
		...
		121: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		122: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		...
		134: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		135: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		...
		159: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		160: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		161: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		162: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		...
		174: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		175: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // MISSINGNO.
		...
		198: { growth_rate: 0x00,
				base_stats: { "hp": 90, "atk": 65, "def": 65, "spd": 15, "spc": 40 },
				types: [ 21, 24 ],
		}, // 𝐆ぅァ7g
		199: { growth_rate: 0x03,
				base_stats: { "hp": 78, "atk": 84, "def": 78, "spd": 100, "spc": 85 },
				types: [ 20, 2 ],
		}, // <PAGE>u\n
		200: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // <PAGE>g𝐄<PAGE>g
		201: { growth_rate: 0x03,
				base_stats: { "hp": 61, "atk": 72, "def": 57, "spd": 65, "spc": 55 },
				types: [ 3 ],
		}, // <PAGE>ァ/gJ1
		202: { growth_rate: 0x95,
		...
		204: { growth_rate: 0x03,
				base_stats: { "hp": 79, "atk": 83, "def": 100, "spd": 78, "spc": 85 },
				types: [ 21 ],
		}, // .8
		205: { growth_rate: 0x03,
				base_stats: { "hp": 79, "atk": 83, "def": 100, "spd": 78, "spc": 85 },
				types: [ 21 ],
		}, // ゥ.B<PAGE>
		206: { growth_rate: 0x03,
				base_stats: { "hp": 79, "atk": 83, "def": 100, "spd": 78, "spc": 85 },
				types: [ 21 ],
		}, // PkMn𝐈<PAGE>pゥぁゥぇ
		...
		208: { growth_rate: 0x03,
				base_stats: { "hp": 45, "atk": 50, "def": 45, "spd": 95, "spc": 115 },
				types: [ 8, 3 ],
		}, // <PAGE><PAGE>ゥ'
		209: { growth_rate: 0x00,
				base_stats: { "hp": 35, "atk": 85, "def": 45, "spd": 75, "spc": 35 },
				types: [ 0, 2 ],
		}, // B<PAGE>ァ┘h
		210: { growth_rate: 0x03,
				base_stats: { "hp": 61, "atk": 72, "def": 57, "spd": 65, "spc": 55 },
				types: [ 3 ],
		}, // PkMn𝐈<PAGE>?<PAGE>A
		211: { growth_rate: 0x05,
				base_stats: { "hp": 75, "atk": 100, "def": 95, "spd": 110, "spc": 70 },
				types: [ 0 ],
		}, // ゥぁゥぇ]
		212: { growth_rate: 0x05,
				base_stats: { "hp": 160, "atk": 110, "def": 65, "spd": 30, "spc": 65 },
				types: [ 0 ],
		}, // <PAGE><PAGE><PAGE>ゥ
		...
		235: { growth_rate: 0x10,
				base_stats: { "hp": 0, "atk": 48, "def": 0, "spd": 88, "spc": 98 },
				types: [ 0, 80 ],
		}, // .4(h4’
		236: { growth_rate: 0x03,
				base_stats: { "hp": 63, "atk": 60, "def": 55, "spd": 71, "spc": 50 },
				types: [ 0, 2 ],
		}, // ?/
		237: { growth_rate: 0xff,
				base_stats: { "hp": 192, "atk": 0, "def": 128, "spd": 16, "spc": 0 },
				types: [ 0 ],
		}, // 4(h4’?
		238: { growth_rate: 0x10,
				base_stats: { "hp": 0, "atk": 48, "def": 0, "spd": 88, "spc": 98 },
				types: [ 0, 80 ],
		}, // <ED>pゥ.4(
		239: { growth_rate: 0x04,
				base_stats: { "hp": 140, "atk": 70, "def": 45, "spd": 45, "spc": 50 },
				types: [ 0 ],
		}, // h4pゥ·ゥ…
		240: { growth_rate: 0x03,
				base_stats: { "hp": 78, "atk": 84, "def": 78, "spd": 100, "spc": 85 },
				types: [ 20, 2 ],
		}, // ゥ(I'
		241: { growth_rate: 0x03,
				base_stats: { "hp": 61, "atk": 72, "def": 57, "spd": 65, "spc": 55 },
				types: [ 3 ],
		}, // 'B'ゥ
		242: { growth_rate: 0x05,
				base_stats: { "hp": 65, "atk": 125, "def": 100, "spd": 85, "spc": 55 },
				types: [ 7 ],
		}, // ゥゥェゥ▷
		243: { growth_rate: 0x10,
				base_stats: { "hp": 0, "atk": 48, "def": 0, "spd": 88, "spc": 98 },
				types: [ 0, 80 ],
		}, // ゥ▲ゥ▼┘ゥ
		244: { growth_rate: 0x03,
				base_stats: { "hp": 63, "atk": 60, "def": 55, "spd": 71, "spc": 50 },
				types: [ 0, 2 ],
		}, // ♂pゥ
		...
		249: { growth_rate: 0x06,
				base_stats: { "hp": 178, "atk": 19, "def": 11, "spd": 0, "spc": 23 },
				types: [ 17, 37 ],
		}, // ぇ<ED><PAGE>└
		250: { growth_rate: 0x00,
				base_stats: { "hp": 65, "atk": 95, "def": 57, "spd": 93, "spc": 85 },
				types: [ 20 ],
		}, // ゥ▼│ゥ♂
