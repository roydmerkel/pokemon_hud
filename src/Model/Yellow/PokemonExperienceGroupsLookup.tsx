export class PokemonExperienceGroupsLookup {
	...
	private static experienceGroupsKV = {
		...
		0x06: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 1, 10, -75, 95, -32); } },
		0x10: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 1, 1, 62, 145, -34); } },
		0x20: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 12, 13, 63, 62, -48); } },
		0x22: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 12, 13, 63, 62, -48); } },
		0x23: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 0, 1, 33, 60, -79); } },
		0x25: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 0, 1, 24, 27, -33); } },
		0x7b: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 3, 2,  -55,   79,  -208); } },
		...
		0x84: { name: "GROWTH_FAST_COPY", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 4, 5,   0,   0,   0); } },
		0x86: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 1, 10, -75, 95, -32); } },
		0x91: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 1, 2, -13, 201, -62); } },
		0x95: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 8, 0, 34, 54, -145); } },
		0xff: { name: "GLITCH", exp_to_level: function(level) { return PokemonExperienceGroupsLookup.growthRate(level, 5, 0, 23, 239, -64); } },
	};
