export class PokemonMovesLookup {
	...
	private static pokemonTmsLookupKV = {
		...
		"-5": { initial: [ 6, 20, 55 ], 
				...
				hms: "last",
				mts: [ ],
				egg_moves: [ ] }, // ghost missingno. -- learnset and tms/hms equal to last pokemon in the team
		"-4": { initial: [ 6, 20, 55 ], 
				levelup: "last", 
				tms: "last", 
				hms: "last",
				mts: [ ],
				egg_moves: [ ]}, // aerodactyl fossil missingno. -- learnset and tms/hms equal to last pokemon in the team
		"-3": { initial: [ 6, 20, 55 ], 
				levelup: "last", 
				tms: "last", 
				hms: "last",
