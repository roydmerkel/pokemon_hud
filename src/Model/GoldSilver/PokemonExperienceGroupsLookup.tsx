export class PokemonExperienceGroupsLookup {
    ...
    private static experienceGroupsKV = {
        ...
        0x0e: { name: "GLITCH", exp_to_level: function (level) { return PokemonExperienceGroupsLookup.growthRate(level, 5, 6, -73, 245, 33); } },
        0x0f: { name: "GLITCH", exp_to_level: function (level) { return PokemonExperienceGroupsLookup.growthRate(level, 11, 4, -67, 1, 40); } },
        0x80: { name: "GLITCH", exp_to_level: function (level) { return PokemonExperienceGroupsLookup.growthRate(level, 15, 10, 4, 208, 167); } },
        0xdb: { name: "GLITCH", exp_to_level: function (level) { return PokemonExperienceGroupsLookup.growthRate(level, 10, 15, -77, 136, 89); } },
        0xe0: { name: "GLITCH_DB_COPY", exp_to_level: function (level) { return PokemonExperienceGroupsLookup.growthRate(level, 10, 15, -77, 136, 89); } },
        0xfc: { name: "GLITCH", exp_to_level: function (level) { return PokemonExperienceGroupsLookup.growthRate(level, 1, 7, -75, 24, 23); } },
        0xff: { name: "GLITCH_FC_COPY", exp_to_level: function (level) { return PokemonExperienceGroupsLookup.growthRate(level, 1, 7, -75, 24, 23); } },
    };
