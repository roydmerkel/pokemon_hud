...
//import TestGoldMonsApp from './TestGoldMonsApp';
let TestGoldMonsApp = null;
if (typeof window?.fetch != 'undefined' && window?.fetch != null) {
    // Check whether ES6 is supported in Modern Browsers
    const module = await import("./TestGoldMonsApp");
    TestGoldMonsApp = module.default;
} else {
