...
import PokemonIndexToDexIndex from './Model/RedBlue/PokemonIndexToDexIndex';
...
import PokemonExperienceGroupsLookup from './Model/RedBlue/PokemonExperienceGroupsLookup';
import PokemonMovesLookup from './Model/RedBlue/PokemonMovesLookup';
import TmsLookup from './Model/RedBlue/TmsLookup';
import HmsLookup from './Model/RedBlue/HmsLookup';
import MtsLookup from './Model/RedBlue/MtsLookup';
import MoveLookup from './Model/RedBlue/MoveLookup';
...
const TestRedIndexesApp: FunctionComponent = () => {
        ...
        for (var i: number = 0; i <= 255; i++) {
            ...
            if (pokedex || pokedex === 0) {
                ...
                mons.push(<tr style={{ width: '100%', height: '100%' }}>
                    ...
                    <td>{(base_stats) ? ((typeof base_stats == 'string') ? base_stats : (("spc" in base_stats) ? base_stats.spc : "undefined")) : "undefined"}</td>
...
export default TestRedIndexesApp;
